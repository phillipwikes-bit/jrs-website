# Contributor spellings, as supplied by Phillip on 2026-08-29

**This file is the authority for how each contributor's name and description is printed.** It supersedes the self-entered strings in `Contributor_Credit_List_2026-08-29.md` for display purposes only. The credit list remains the record of who confirmed, which code they hold, and whether they elected to be named; this file governs only the characters that reach the page.
